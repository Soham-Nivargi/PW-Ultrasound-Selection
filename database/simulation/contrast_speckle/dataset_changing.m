...
path_dataset = [phantom,'_',acqui,'_dataset_',data,'.hdf5'];
path_scan = [phantom,'_',acqui,'_scan.hdf5'];
% path_reconstruted_img = ['reconstructed_image/',acquisition,'/',phantom,'/trying_',phantom,'_',acqui,'_img_from_',data,'.hdf5'];
