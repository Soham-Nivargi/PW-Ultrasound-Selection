function [beamform_max, ind_max, contrast_max] = das_iq_for_greedy_exp(scan,pht, dataset,pw_indices,flag_simu,flag_display,iter_beamform,contrast_reg,init_flag)
    ...
    for k=1:length(pw_indices)
        ...
        for pw=pw_indices{k}
            ...
            contrast_reg =  tools.contrast_score(scan, pht, temp_us, flag_simu, flag_display, j);
