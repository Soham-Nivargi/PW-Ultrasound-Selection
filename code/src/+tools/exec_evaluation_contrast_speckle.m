% function score_contrast = exec_evaluation_contrast_speckle(path_scan,path_phantom,path_img,flag_simu,flag_display,path_output)
% 
...
function score_contrast = exec_evaluation_contrast_speckle(path_scan, path_phantom, path_img, flag_simu, flag_display, path_output)
    ...
    % Initialize score_contrast as an array
    score_contrast = [];
    ...
    % Return score_contrast after the loop
    return;
end
