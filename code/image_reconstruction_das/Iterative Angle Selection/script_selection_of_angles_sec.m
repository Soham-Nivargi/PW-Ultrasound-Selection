...
while ~isempty(queue)
    [beamform_curr, pw_indices, queue] = selection_angles_seq_sec(scan,dataset,pht,pw_indices,0.99,...
        queue, beamform_curr);
...
saveas(gcf,'Results/Sampling Strategies/Paper_modifications/unwindowed/simulation/queue_final_result.jpg');
reg_us.write_file('Results/Sampling Strategies/Paper_modifications/unwindowed/simulation/queue_final_result.hdf5');
tools.exec_evaluation_contrast_speckle(path_scan,path_pht,'Results/Sampling Strategies/Paper_modifications/unwindowed/simulation/queue_final_result.hdf5',flag_simu,flag_display,'Results/Sampling Strategies/Paper_modifications/unwindowed/simulation/queue_final_result.txt');
