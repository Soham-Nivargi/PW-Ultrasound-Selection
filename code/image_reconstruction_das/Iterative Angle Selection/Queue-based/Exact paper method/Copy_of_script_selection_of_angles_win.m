...
saveas(gcf,'Results/Simulation/Angle Limit/windowed_final_result.jpg');
reg_us.write_file('Results/Simulation/Angle Limit/windowed_final_result.hdf5');
tools.exec_evaluation_contrast_speckle(path_scan,path_pht,'Results/Simulation/Angle Limit/windowed_final_result.hdf5', ...
    flag_simu,flag_display,'Results/Simulation/Angle Limit/windowed_final_result.txt');
save('Results/Simulation/Angle Limit/variables_windowed.mat', 'pw_indice');
