...
saveas(gcf,'Results/Simulation/Threshold limit/windowed_final_result.jpg');
reg_us.write_file('Results/Simulation/Threshold limit/windowed_final_result.hdf5');
tools.exec_evaluation_contrast_speckle(path_scan,path_pht,'Results/Simulation/Threshold limit/windowed_final_result.hdf5', ...
    flag_simu,flag_display,'Results/Simulation/Threshold limit/windowed_final_result.txt');
save('Results/Simulation/Threshold limit/variables_windowed.mat', 'pw_indice');
