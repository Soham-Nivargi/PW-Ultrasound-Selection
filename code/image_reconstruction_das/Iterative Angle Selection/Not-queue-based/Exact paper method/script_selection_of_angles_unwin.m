...
beamform_curr = das_iq_paper_unwindowed(scan, dataset, pw_indices);
...
[beamform_curr, pw_indices] = selection_angles_seq_unwin(scan,dataset,pw_indices,thresh,...
        1, dataset.firings, beamform_curr);
    % queue(1) = [];  
% end
...
saveas(gcf,'Results/Simulation/Threshold limit/final_result_unwindowed.jpg');
reg_us.write_file('Results/Simulation/Threshold limit/final_result_unwindowed.hdf5');
tools.exec_evaluation_contrast_speckle(path_scan,path_pht,'Results/Simulation/Threshold limit/final_result_unwindowed.hdf5', ...
    flag_simu,flag_display,'Results/Simulation/Threshold limit/final_result.txt');
