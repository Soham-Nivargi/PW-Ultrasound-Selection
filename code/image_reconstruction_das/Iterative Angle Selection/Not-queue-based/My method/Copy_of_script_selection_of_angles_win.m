...
saveas(gcf,'Results/Simulation/Angle Limit/final_result_windowed.jpg');
reg_us.write_file('Results/Simulation/Angle Limit/final_result_windowed.hdf5');
tools.exec_evaluation_contrast_speckle(path_scan,path_pht,'Results/Simulation/Angle Limit/final_result_windowed.hdf5', ...
    flag_simu,flag_display,'Results/Simulation/Angle Limit/final_result_windowed.txt');
save('Results/Simulation/Angle Limit/variables_windowed.mat', 'pw_indices');
