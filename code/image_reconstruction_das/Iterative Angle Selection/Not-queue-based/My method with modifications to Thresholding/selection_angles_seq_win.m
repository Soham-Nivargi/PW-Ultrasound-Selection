function [beamform_curr, pw_indices] = selection_angles_seq_win(scan,dataset,pht,pw_indices,thresh,left,mid,right,beamform_curr)
    ...
    [beamform_res, beamform_comp] = das_iq_for_selection_win(scan,pht,dataset,pw_indice,beamform_curr,length(pw_indices));
    ...
    if left_sim < thresh
        if(right_sim<thresh)
            if left_sim>right_sim
                ...
                [beamform_curr, pw_indices] = selection_angles_seq_win(scan,dataset,pht,pw_indices,0.99,...
