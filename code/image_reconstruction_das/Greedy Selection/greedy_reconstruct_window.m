...
saveas(gcf, ['Results/greedy_simulation/new_window/greedy_selection_',phantom,'_',acqui,'_img_from_',data,'_K_',num2str(K),'.jpg']);


%-- Save results
image.write_file(path_reconstruted_img);

tools.exec_evaluation_contrast_speckle(path_scan,path_pht,path_reconstruted_img, ...
    flag_simu,flag_display, ...
    ['Results/greedy_simulation/new_window/greedy_selection_',phantom,'_',acqui, ...
    '_img_from_',data,'_K_',num2str(K),'.txt']);
