...
% while ~isempty(queue)
[beamform_curr, pw_indices,thresh] = Copy_of_selection_angles_seq_win(scan,dataset,pht,pw_indices,14, ...
...
saveas(gcf,'Results/simulation/Angle Limit/Window-16 Blurred/final_result_windowed.jpg');
reg_us.write_file('Results/simulation/Angle Limit/Window-16 Blurred/final_result_windowed.hdf5');
tools.exec_evaluation_contrast_speckle(path_scan,path_pht,'Results/simulation/Angle Limit/Window-16 Blurred/final_result_windowed.hdf5', ...
    flag_simu,flag_display,'Results/simulation/Angle Limit/Window-16 Blurred/final_result_windowed.txt');
save('Results/simulation/Angle Limit/Window-16 Blurred/variables_windowed.mat', 'pw_indices');
