...
while ~isempty(queue)
    [beamform_curr, pw_indice, queue] = selection_angles_seq_win(scan,pht,dataset,pw_indice,thresh,...
        queue, beamform_curr);
    queue(1) = [];  
end
...
saveas(gcf,'Results/simulation/Threshold limit/Window-16 Blurred/final_result_windowed.jpg');
reg_us.write_file('Results/simulation/Threshold limit/Window-16 Blurred/final_result_windowed.hdf5');
tools.exec_evaluation_contrast_speckle(path_scan,path_pht,'Results/simulation/Threshold limit/Window-16 Blurred/final_result_windowed.hdf5', ...
    flag_simu,flag_display,'Results/simulation/Threshold limit/Window-16 Blurred/final_result_windowed.txt');
save('Results/simulation/Threshold limit/Window-16 Blurred/variables_windowed.mat', 'pw_indice');
