...
pw_indices{1} = [38 34 42 22 54 30 46 18 58 14 62 10 66 26 50]; %uniform
...
switch data_type    
    case 1
        % disp(arr{i});
        image1 = das_iq_windowed(scan,pht,dataset,pw_indices);
...
image1.show();
saveas(gcf,'Results/simulation/Window-21 Non-Blurred/final_result_windowed.jpg');
image1.write_file('Results/simulation/Window-21 Non-Blurred/final_result_windowed.hdf5');
tools.exec_evaluation_contrast_speckle(path_scan,path_pht,'Results/simulation/Window-21 Non-Blurred/final_result_windowed.hdf5', ...
    flag_simu,flag_display,'Results/simulation/Window-21 Non-Blurred/final_result_windowed.txt');
% save('Results/simulation/Windvariables_windowed.mat', 'pw_indices');
