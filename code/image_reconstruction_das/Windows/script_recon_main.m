...
%-- dataset.firings corresponding to the total number of emitted steered plane waves
...
switch data_type    
    case 1
        % disp(arr{i});
        image1 = das_iq_windowed(scan,pht,dataset,pw_indices, path_scan, flag_simu, flag_display);
